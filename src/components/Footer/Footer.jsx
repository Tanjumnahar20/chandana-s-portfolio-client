...
const Footer = () => {
    return (
        <footer className="mt-10 py-10 text-orange-400 w-[80%] mx-auto" id='footer'>
        <div className='footer-wrapper footer'>
          <div className='footer-span mr-20'>
            <h2 className='text-2xl font-bold text-start text-orange-400 footer-title'>Tanjum Nahar</h2>
            <p className=' font-semibold text-start text-orange-400'>As a full-stack web developer, I am passionate about working for a software company where I can hardness my talents in web design, front-end, back-end, UI and UX design web development to provide excellent customer service.</p>
          </div>
          ...
          <div className='flex flex-col footer-span'>
            ...
            <div className="form-control lg:w-80">
              ...
              <div className="relative">
                ...
                <button className="btn bg-orange-400 absolute top-0 right-0 rounded-l-none text-white">Subscribe</button>
              </div>
            </div>
  
            <div className='w-[100%] mx-auto my-5'>
              <div className="flex justify-center items-center gap-8">
                <a href="https://www.facebook.com/profile.php?id=100014444222267" target="_blank" rel="noreferrer">
                ...
                <a href="https://github.com/Tanjumnahar20" target="_blank" rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
        ...
        <div className='mt-10'>
          <p className='text-center'>Copyright © 2024 - All right reserved by Tanjum Nahar</p>
        </div>
      </footer>
    );
};
