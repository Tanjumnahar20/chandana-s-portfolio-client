...
const Contact = () => {
    ...
    return (
        <div id='contact' className='lg:w-[80%] md:w-[90%] mx-auto mt-8'>
        ...
        <div className='flex flex-col lg:flex-row justify-center items-center gap-5'>
            <div className="card rounded lg:rounded-md flex-shrink-0 bg-accent w-full max-w-md shadow-2xl">
                <div className="card-body text-left">
                    <h1 className='text-left text-gray-300 text-xl'>Contact Info</h1>
                    <p className='text-left text-gray-300 text-xl'>Feel free to contact me!</p>
                    ...
                    <div className='flex items-center mb-5 text-gray-300'>
                        ...
                        <div className='p-2'>
                            <h1>Email Me</h1>
                            <p>tanjumnaharchandana@gmail.com</p>
                        </div>
                    </div>
            ...
            <div className="card rounded bg-accent lg:rounded-md flex-shrink-0 w-full max-w-md shadow-2xl">
                <div className="card-body">
                    <h1 className='text-gray-300 text-center text-xl pt-2'>Contact me</h1>
