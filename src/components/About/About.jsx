        ...
        <div className="card rounded-none lg:card-side bg-black shadow-xl">
            ...
            <div className="about-me card-body p-10">
                ...
                <div className='text-lg text-gray-400'>
                    I'm Tanjum Nahar.
                    <br />
                    My Email : tanjumnaharchandana@gmail.com
                    <br />
                    Address: Dhaka, Bangladesh
                    <br />
                    <div className='py-5 flex flex-row gap-4'>
                        <a href="https://www.linkedin.com/in/sharif-hasan-073a58218/">
                        ...
                        <a href="https://github.com/hasansharif819">
